...
} else if (readFile == "C:/Users/esham/Desktop/R Project Stuff/Datasets/case0902.csv") {
    varData$V1 = NULL
    names(varData) <- c("Y", "V1", "V2", "V3")
} else if (readFile == "C:/Users/esham/Desktop/R Project Stuff/Datasets/fbData.csv") {
    varData$V2 = NULL
    varData$V3 = NULL
    varData$V4 = NULL
    varData$V5 = NULL
